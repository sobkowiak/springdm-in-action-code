package com.manning.sdmia.ch06.enterprise.modular.dao;
 ...
 *
 */
public class EnterpriseModularDaoJdbcTest extends AbstractConfigurableBundleCreatorTests {
	...
	protected String[] getConfigLocations() {
		return new String [] {"/com/manning/sdmia/ch06/enterprise/modular/dao/EnterpriseModularDaoJdbcTest-context.xml"};
	}
