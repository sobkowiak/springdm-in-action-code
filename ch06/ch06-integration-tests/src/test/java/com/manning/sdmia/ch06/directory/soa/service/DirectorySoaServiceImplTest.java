package com.manning.sdmia.ch06.directory.soa.service;
...
public class DirectorySoaServiceImplTest extends AbstractConfigurableBundleCreatorTests {
	...
	protected String[] getTestBundlesNames() {
		return new String [] {
				...
				"com.manning.sdmia.ch06, directory-soa-service-impl, 1.0.0",			
	...
	protected String[] getConfigLocations() {
		return new String [] {"/com/manning/sdmia/ch06/directory/soa/service/DirectorySoaServiceImplTest-context.xml"};
	}
