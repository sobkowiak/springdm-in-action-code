package com.manning.sdmia.ch06.enterprise.modular.service;
 ...
 *
 */
public class EnterpriseModularServiceImplTest extends AbstractConfigurableBundleCreatorTests {
	...
	protected String[] getTestBundlesNames() {
		return new String [] {
				...
				"com.manning.sdmia, enterprise-modular-dao, 1.0.0-SNAPSHOT",	
				"com.manning.sdmia, enterprise-modular-dao-jdbc, 1.0.0-SNAPSHOT",		
				"com.manning.sdmia, enterprise-service, 1.0.0-SNAPSHOT",			
				"com.manning.sdmia, enterprise-modular-service-impl, 1.0.0-SNAPSHOT",			
	...
	protected String[] getConfigLocations() {
		return new String [] {"/com/manning/sdmia/ch06/enterprise/modular/service/EnterpriseModularServiceImplTest-context.xml"};
	}
