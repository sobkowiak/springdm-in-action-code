...
public class EnterpriseWebSoaTest extends AbstractConfigurableBundleCreatorTests {
	...
	protected String[] getTestBundlesNames() {
		...
		col.add("com.manning.sdmia, enterprise-soa-service-impl, 1.0.0-SNAPSHOT");
	...
	protected String[] getConfigLocations() {
		return new String [] {"/com/manning/sdmia/ch06/enterprise/web/EnterpriseWebSoaTest-context.xml"};
	}
