...
public class DrawingFrame extends JFrame implements MouseListener,
	...
	private Map<String,ShapeInfo> m_shapes = new HashMap<String,ShapeInfo>();
	 ...
	 */
	public SimpleShape removeShape(String name) {
		// remove the shape from the 
		ShapeInfo shapeInfo = m_shapes.remove(name);

		// if the shape was selected, unselect it
		...
		// select the first button, if any
