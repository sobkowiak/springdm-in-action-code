...
build (package Maven goal) both projects, start the database (database directory) and launch the datasource.args pax-runner file (pax-run --args=file:datasource.args). You should see a message on the console, telling the connection was successful.