 ...
 */
public class CmBeanManagedServiceTest extends AbstractCmTest {
	...
	protected String[] getConfigLocations() {
		return new String [] {"/com/manning/sdmia/ch11/cm/managedservice/cm-bean-managedservice-context.xml"};
	}
