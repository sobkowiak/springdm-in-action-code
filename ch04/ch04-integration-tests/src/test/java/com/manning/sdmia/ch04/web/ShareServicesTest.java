...
public class ShareServicesTest extends
	...
	public void testShareServices() throws Exception {
		...
		// checks the servlet that uses the OSGi service
		Assert.assertEquals(
				"<html><head><title>The answer to life, the universe and everything</title></head>" +
				"<body><h1>The answer to life, the universe and everything is:</h1><p>42</p></body></html>", 
				getTextResponse("http://localhost:8080/webapp/answerServlet")
		);
	}	
	...
	protected String[] getTestBundlesNames() {
		return new String [] {
			...
			"com.manning.sdmia, ch04-web-repositorybundle, 1.0-SNAPSHOT",
			"com.manning.sdmia, ch04-web-webapp, 1.0-SNAPSHOT",	
		};
	}
